...
const handball = {}
 do {
    ...
    switch (option){
        ...
        handball.rules = alert('Tempo de posse: não há limite de tempo, mas ataques passivos são penalizados. Substituições:bom as substituições de jogadores são ilimitadas .')
